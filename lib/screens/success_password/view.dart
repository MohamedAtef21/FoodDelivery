...
class SuccessPasswordView extends StatelessWidget {
  const SuccessPasswordView({Key? key}) : super(key: key);
          ...
          Center(
            child: Column(
              ...
              children: [
                ...
                Text("Password reset succesful",style: TextStyle(fontSize: 23,fontFamily: "Ben",color: Color(0xff09051C),fontWeight: FontWeight.bold),),
                SizedBox(height: 192.h,),
                GestureDetector(onTap: (){
                  navigateTo(context, PagesNavView());
                },
                child: AppInputView(text: "Back"),),
              ],
            ),
          ),
        ],
